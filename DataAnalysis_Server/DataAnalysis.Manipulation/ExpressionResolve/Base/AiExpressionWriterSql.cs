...
namespace DataAnalysis.Manipulation.ExpressionResolve.Base
{
    ...
    internal class AiExpressionWriterSql : AiExpressionVisitor
    {
        ...
        string aiSelectRsult = string.Empty;
        int aiOrderTime = 0;
        ...
        public static string BizSelectWriteToString(Expression expression, AiExpSqlType bizSql)
        {
            StringWriter sw = new StringWriter();
            return Write(sw, expression, bizSql);
        }
