...
namespace DataAnalysis.Manipulation.ExpressionResolve
{
    ...
    public class ResolveExpression
    {
        ...
        public IDbDataParameter[] Paras;

        /// <summary>
        /// 解析lamdba，生成Sql查询条件
        /// </summary>
        /// <returns></returns>
        public void ResolveToWhere(Expression expression, DataBaseType dbType = DataBaseType.SqlServer)
        {
            ...
            switch (dbType)
            {
                case DataBaseType.MySql:
                    this.Paras = Argument.Select(x => new MySqlParameter(x.Key, x.Value)).ToArray();
                    break;
                default:
        ...
        public void ResolveToOrder(Expression expression)
        {
            SqlOrder = AiExpressionWriterSql.BizWhereWriteToString(expression, AiExpSqlType.aiOrder);
        }
        ...
        private string ResolveFunc(Expression left, Expression right, ExpressionType expressiontype)
        {
            ...
            {
                CompName = SetArgument(Name, Value);
            }
        ...
        private string Len(MethodCallExpression expression, object value, ExpressionType expressiontype)
        {
            ...
            string CompName = SetArgument(Name.ToString(), value);
