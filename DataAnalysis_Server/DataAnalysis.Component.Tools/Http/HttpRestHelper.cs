...
namespace DataAnalysis.Component.Tools.Http
{
    public  class HttpRestHelper
    {
        ...
        /// API域名名称
        /// </summary>
        private static readonly string HUOBI_HOST = AppSetting.GetConnection("HuoBi", "HuoBiHost");
        /// <summary>
        /// APi域名地址
        /// </summary>
        private static readonly string HUOBI_HOST_URL = string.Empty;
        /// <summary>
        /// 加密方法
        /// </summary>
        private static readonly string HUOBI_SIGNATURE_METHOD = AppSetting.GetConnection("HuoBi", "HuoBiSign");
        /// <summary>
        /// API版本
        /// </summary>
        private static readonly int HUOBI_SIGNATURE_VERSION = int.Parse(AppSetting.GetConnection("HuoBi", "HuoBiVersion"));
        /// <summary>
        /// ACCESS_KEY
        /// </summary>
        private static readonly string ACCESS_KEY = AppSetting.GetConnection("HuoBi", "AccessKeyID");
        /// <summary>
        /// SECRET_KEY()
        /// </summary>
        private static readonly string SECRET_KEY = AppSetting.GetConnection("HuoBi", "SecretKey");

        private static RestClient client;//http请求客户端

        static HttpRestHelper()
        {
        ...
        #region HTTP请求方法
        public static string SendRequest(string resourcePath, string parameters = "")
        {
        ...
        /// <returns></returns>
        public static HBResponse<T> SendRequestEncryption<T>(string resourcePath, string parameters = "") where T : new()
        {
        ...
        public static HBResponse<T> SendRequest<T, P>(string resourcePath, P postParameters) where T : new()
        {
        ...
        /// <returns></returns>
        private static string GetSignatureStr(Method method, string host, string resourcePath, string parameters)
        {
